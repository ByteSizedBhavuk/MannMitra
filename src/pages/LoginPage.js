...
//       console.log("User session:", data);     //do not push in production
//       console.log(data.session.access_token);   // do not push in production
//        navigate('/Studentdashboard'); 
//       // 👉 redirect to dashboard here (using React Router or state)
//     }
//   };
